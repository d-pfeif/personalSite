...
import ventLogo from '../assets/ventureIMG.png'
    ...
    return(
      <div id="projects">
        ...
        <div className="projSlideL" style={{marginLeft: this.props.margin1 + "em"}}>
          <ProjectSlides logo={ventLogo} title="Venture" description="A web application designed to help users locate and contribute activities they find educational, exciting, and fun!" urllink="https://ad-venture.herokuapp.com" gitlink="https://github.com/d-pfeif/venture"/>
        </div>
        ...
        <div className="projSlideL" style={{marginLeft: this.props.margin5 + "em"}}>
